...
namespace GoodToCode.Entities.Web.Controllers
{
    public class SettingsController : Controller
    {
        ...
        public SettingsController(EntityDataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SettingId,SettingKey,SettingTypeKey,SettingName,SettingValue,CreatedDate,ModifiedDate")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SettingId,SettingKey,SettingTypeKey,SettingName,SettingValue,CreatedDate,ModifiedDate")] Setting setting)
        {
