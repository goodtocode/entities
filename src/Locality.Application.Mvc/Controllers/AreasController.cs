...
namespace GoodToCode.Locality.Controllers
{
    public class AreasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AreaId,AreaKey,CreatedDate")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AreaId,AreaKey,CreatedDate")] Area area)
        {
            if (id != area.AreaId)
            {
                return NotFound();
