...
namespace Shared.Specs.Subjects.Entity
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Businesses Get", Description="\tGet all Businesses from persistence", SourceFile="Subjects\\Entity\\BusinessesGet.feature", SourceLine=0)]
