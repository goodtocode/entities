...
namespace Shared.Specs.Subjects.Entity
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Business Get by Key", Description="\tGet a Business from persistence", SourceFile="Subjects\\Entity\\BusinessGetByKey.feature", SourceLine=0)]
