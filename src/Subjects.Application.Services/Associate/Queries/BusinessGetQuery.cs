...
//        public BusinessGetQuery(int examId, int programId, int customerKey)
//        {
//            Examkey = examId;
...
//                    try
//                    {
//                        var examResult = _testRunExamRepo.GetLatest(request.CustomerId, request.ProgramId, request.ExamKey);
