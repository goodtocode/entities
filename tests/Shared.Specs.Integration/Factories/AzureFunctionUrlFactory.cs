...
namespace GoodToCode.Subjects.Specs
{
    public class AzureFunctionUrlFactory : ICrudUrlFactory
    {
        ...
        public string CreateUrl { get { return _config["Apis:CreateUrlMask"].Replace("{UrlBase}", _config["Functions:UrlBase"]).Replace("{DomainModel}", DomainModel); } }
        public string UpdateUrl { get { return _config["Apis:UpdateUrlMask"].Replace("{UrlBase}", _config["Functions:UrlBase"]).Replace("{DomainModel}", DomainModel).Replace("{RowKey}", RowKey.ToString()); } }
        public string SaveUrl { get { return _config["Apis:SaveUrlMask"].Replace("{UrlBase}", _config["Functions:UrlBase"]).Replace("{DomainModel}", DomainModel).Replace("{RowKey}", RowKey.ToString()); } }
        public string DeleteUrl { get { return _config["Apis:DeleteUrlMask"].Replace("{UrlBase}", _config["Functions:UrlBase"]).Replace("{DomainModel}", DomainModel).Replace("{RowKey}", RowKey.ToString()); } }
