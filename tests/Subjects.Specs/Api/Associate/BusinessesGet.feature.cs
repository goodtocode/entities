...
namespace GoodToCode.Subjects.Api.Associate
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Businesses Get from Web API", Description="\tGet all Businesses from Web API", SourceFile="Api\\Associate\\BusinessesGet.feature", SourceLine=0)]
