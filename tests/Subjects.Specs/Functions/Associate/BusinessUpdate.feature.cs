...
namespace GoodToCode.Subjects.Functions.Associate
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Business Update", Description="\tUpdate a new business into persistence", SourceFile="Functions\\Associate\\BusinessUpdate.feature", SourceLine=0)]
